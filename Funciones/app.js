...
window.onload = () => {
  ...
  <div class="header-escritorio">
    <a title="Conectar LAB" href="#top">
      <img class="header-logo" src="./Imagenes/club-atletico-river-plate-logo-black-and-white.png" alt="Logo de Conectar LAB" />
    </a>
  ...
  <a title="Conectar LAB" href="#top">
    <img class="header-logo" src="./Imagenes/club-atletico-river-plate-logo-black-and-white.png"  >
  </a>
`;
};
